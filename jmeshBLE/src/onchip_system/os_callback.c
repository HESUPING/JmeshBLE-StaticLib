...
//    jmesh_model_bind_app(&light_client,jmesh_appkey_get_by_key_index(0,1));
//    jmesh_model_bind_app(&light_server,jmesh_appkey_get_by_key_index(0,1));
//    jmesh_model_bind_app(&light_config,jmesh_appkey_get_by_key_index(0,1));
//    jmesh_model_bind_app(&realcomm_client,jmesh_appkey_get_by_key_index(0,1));
//    jmesh_model_bind_app(&realcomm_server,jmesh_appkey_get_by_key_index(0,1));
//    jmesh_model_bind_app(&realcomm_config,jmesh_appkey_get_by_key_index(0,1));
