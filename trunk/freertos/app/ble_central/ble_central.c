...
///App device name
#define APP_DEVICE_NAME "BlueX Observer"
 ...
 *
 */
__weak void osapp_user_main_init(void)
{
	 osapp_ble_stack_run();
...
static void osapp_gapm_profile_added_ind_handler(ke_msg_id_t const msgid, void const *param,ke_task_id_t const dest_id,ke_task_id_t const src_id)
{
	struct gapm_profile_added_ind *ind = (struct gapc_connection_req_ind *)param;
