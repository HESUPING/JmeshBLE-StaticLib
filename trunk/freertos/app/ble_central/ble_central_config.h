...
#define BLE_CENTRAL_SIMPLE	/**<An example for Bx2400 using as a ble peripheral. Only one BLE_CENTRAL_xx macro can be defined. */
#define BLE_BX2400_SIMPLE_CLIENT /**<An example for Bx2400 using as a ble bx2400 simple client.*/
