...
#define BLE_PERIPHERAL_SIMPLE	/**<An example for Bx2400 using as a ble peripheral. Only one BLE_PERIPHERAL_xx macro can be defined. */
#define BLE_BX2400_SIMPLE_SERVER /**<An example for Bx2400 using as a ble bx2400 simple server.*/
