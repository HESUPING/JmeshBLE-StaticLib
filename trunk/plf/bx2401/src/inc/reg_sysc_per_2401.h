...
typedef union
{
    ...
    struct
    {
        uint32_t                   clk_sel_iic0 :  2; /* 1: 0, clock select:2'b00:  clk_32m2'b01:  divide from clk_32m2'b10:  clk_pll2'b11:  divide from clk_pll*/
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t     clk_div_uart0_para_num1_m1 :  4; /*27:24, for first (clk_div_uart0_para_num1_m1+1) uart clk cycles clk_uart=clk/(clk_div_uart0_para_len1_m1+1)for following (clk_div_uart0_para_num0_m1+1) uart clk cycles clk_uart=clk/(clk_div_uart0_para_len0_m1+1)clk can be clk_32m or clk_pllclk_div_uart0_len*_m1 is zero means divide by 2*/
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t                     reserved_1 :  4; /*23:20,                             NA*/
        uint32_t     clk_div_uart1_para_num1_m1 :  4; /*27:24, for first (clk_div_uart1_para_num1_m1+1) uart clk cycles clk_uart=clk/(clk_div_uart1_para_len1_m1+1)for following (clk_div_uart1_para_num0_m1+1) uart clk cycles clk_uart=clk/(clk_div_uart1_para_len0_m1+1)clk can be clk_32m or clk_pllclk_div_uart1_len*_m1 is zero means divide by 2*/
        uint32_t                     reserved_0 :  4; /*31:28,                             NA*/
    } bit_field;
