...
typedef struct
{
    ...
    uint8_t dfs_32:5, /**< Data Frame Size.  */
    ...
    union
    {
        struct
        {
            ...
            uint8_t valid_cs_mask; /**< Valid CS pin mask. */
 ...
 * @brief SPI TX
 * @param[in] hdl the peripheral common instance handler(pointer) for the SPI instance
 * @param[in] cs_sel_mask CS pins select mask for the transfer (invalid for spi slave)
