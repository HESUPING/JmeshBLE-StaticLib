...
#if defined(BLE_JMESH_PROV_S)
#define BLE_JMESHS_PROV_SERVER    1
#else
#define BLE_JMESHS_PROV_SERVER    0
#endif

#if defined(BLE_JMESH_PROV_C)
#define BLE_JMESHC_PROV_CLIENT    1
#else
#define BLE_JMESHC_PROV_CLIENT    0
#endif

#if defined(BLE_JMESH_APP_S)
#define BLE_JMESHS_APP_SERVER    1
#else
#define BLE_JMESHS_APP_SERVER    0
#endif
...
/// BLE_CLIENT_PRF indicates if at least one client profile is present
        ...
        || BLE_UDS_CLIENT || BLE_BCS_CLIENT || BLE_WPT_CLIENT || BLE_PLX_CLIEN || BLE_BXOTA_CLIENT)
